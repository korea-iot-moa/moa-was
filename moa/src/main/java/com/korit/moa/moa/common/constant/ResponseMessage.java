...
public class ResponseMessage {
    ...
    public static final String NOT_EXIST_GROUP = "Group does not exist."; // 사용자가 존재하지 않을 때 반환 메시지
    ...
    public static final String DUPLICATED_TEL_NICKNAME = "Duplicated NickName."; // 전화번호 중복 시 반환 메시지
    ...
    public static final String EMAIL_AUTH_FAIL = "Email authentication failed."; // 전화번호 인증 실패 시 반환 메시지
    ...
    public static final String NOT_MATCH_BIRTHDAY = "Birthday does not match."; // 이름 불일치 시 반환 메시지
